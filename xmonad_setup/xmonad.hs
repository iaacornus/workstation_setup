...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    , ((modm .|. shiftMask, xK_Return), setLayout $ XMonad.layoutHook conf)

    -- Resize viewed windows to the correct size
    , ((mod1Mask, xK_Return), refresh)
...
--
main = do
    xmproc <- spawnPipe "xmobar ~/.xmobarrc/xmobarrc"
